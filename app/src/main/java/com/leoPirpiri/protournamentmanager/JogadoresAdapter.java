...
public class JogadoresAdapter extends RecyclerView.Adapter<JogadoresAdapter.ViewHolder> implements View.OnClickListener, View.OnLongClickListener {
    ...
    private final ArrayList<Score> acoesTime;
    ...
    public void onBindViewHolder(@NonNull JogadoresAdapter.ViewHolder holder, int position) {
        ...
        if (acoesTime == null) {
            ...
            if (acoesIndividuais.containsKey(Score.TIPO_PONTO)){
                ...
                if(gols!=1){
                    holder.pontoProJogador.setText(Integer.toString(gols));
                } else {
            ...
            if (acoesIndividuais.containsKey(Score.TIPO_AUTO_PONTO)){
                ...
                if(autoGol!=1){
                    holder.pontoContraJogador.setText(Integer.toString(autoGol));
                } else {
            ...
            switch (quantCartoes){
                case 0:
                    ...
                    break;
                case 1:
                    holder.cartaoJogador.setBackground(context.getDrawable(R.drawable.acao_add_card_amarelo));
                    holder.cartaoJogador.setVisibility(View.VISIBLE);
                    break;
                default:
                    holder.cartaoJogador.setBackground(context.getDrawable(R.drawable.acao_add_card_vermelho));
                    holder.cartaoJogador.setVisibility(View.VISIBLE);
                    break;
            }
        }
